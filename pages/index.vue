  ...
  <div class="container pt-3">
    <div class="row">
      <div class="col-md-6 offset-3 pt-3 card border border-success shadow">
        ...
        <div class="button-container mt-3 mb-3">
          ...
          <button @click="deleteValue" class="btn btn-danger">
            Delete Value
          </button>
        </div>
        <div
        ...
        >
          <p class="m-0">
            <strong>localStorage Değeri :</strong> {{ fromStorage }}
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="row mt-5">
      <div class="col-md-6 offset-3 pt-3 card border border-primary shadow">
        ...
        <div class="button-container mt-3 mb-3">
          <button @click="setCookie" class="btn btn-primary">
            Set Cookie Value
          </button>
          <button @click="getCookie" class="btn btn-primary">
            Get Cookie Value
          </button>
          <button @click="deleteCookie" class="btn btn-danger">
            Delete Cookie Value
          </button>
        </div>
        <div
